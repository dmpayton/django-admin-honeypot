...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LoginAttempt.path'
        db.alter_column(u'admin_honeypot_loginattempt', 'path', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'LoginAttempt.path'
        db.alter_column(u'admin_honeypot_loginattempt', 'path', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
